...
class BaseExplorerService {
    ...
    flatMap(modules, callback) {
        ...
        const unwrap = (moduleRef) => {
            ...
            const imported = ((_a = moduleRef.imports) === null || _a === void 0 ? void 0 : _a.size) ? [...moduleRef.imports.values()].reduce((prev, cur) => {
                return [...prev, ...unwrap(cur)];
            }, [])
                : [];
            return [...defined, ...imported];
        };
        return lodash_1.flattenDeep(modules.map(unwrap)).filter(lodash_1.identity);
    }
}
